...
SC_GetTriggerConfigParamsBlock.argtypes = []
...
SC_RequestDigitalOutputs.argtypes = []
...
SC_RequestTriggerConfigParams.argtypes = []
...
SC_SetTriggerConfigParamsBlock.argtypes = []
