...
BMC_GetAnalogMonitorConfigParams.argtypes = []
...
BMC_GetAnalogMonitorConfigParamsBlock.argtypes = []
...
BMC_GetAuxIOPortConfigParams.argtypes = []
...
BMC_GetAuxIOPortConfigParamsBlock.argtypes = []
...
BMC_GetIOPortConfigParams.argtypes = []
...
BMC_GetIOPortConfigParamsBlock.argtypes = []
...
BMC_GetJoystickParams.argtypes = []
...
BMC_GetLCDMoveParamsBlock.argtypes = []
...
BMC_GetLCDParamsBlock.argtypes = []
...
BMC_GetPositionTriggerState.argtypes = []
...
BMC_GetRackDigitalOutputs.argtypes = []
...
BMC_GetRackStatusBits.argtypes = []
...
BMC_GetRasterScanMoveParams.argtypes = []
...
BMC_GetTriggerIOConfigParamsBlock.argtypes = []
...
BMC_RegisterSynchronizedMoveCompleteCallback.argtypes = []
...
BMC_RequestAnalogMonitorConfigParams.argtypes = []
...
BMC_RequestAuxIOPortConfigParams.argtypes = []
...
BMC_RequestIOPortConfigParams.argtypes = []
...
BMC_RequestJoystickParams.argtypes = []
...
BMC_RequestLCDMoveParams.argtypes = []
...
BMC_RequestPositionTriggerState.argtypes = []
...
BMC_RequestRackDigitalOutputs.argtypes = []
...
BMC_RequestRackStatusBits.argtypes = []
...
BMC_RequestRasterScanMoveParams.argtypes = []
...
BMC_RequestSettledCurrentLoopParams.argtypes = []
...
BMC_RequestTriggerIOConfigParams.argtypes = []
...
BMC_SetAnalogMonitorConfigParams.argtypes = []
...
BMC_SetAnalogMonitorConfigParamsBlock.argtypes = []
...
BMC_SetAuxIOPortConfigParams.argtypes = []
...
BMC_SetAuxIOPortConfigParamsBlock.argtypes = []
...
BMC_SetIOPortConfigParams.argtypes = []
...
BMC_SetIOPortConfigParamsBlock.argtypes = []
...
BMC_SetJoystickParams.argtypes = []
...
BMC_SetLCDMoveParamsBlock.argtypes = []
...
BMC_SetLCDParamsBlock.argtypes = []
...
BMC_SetMultiChannelMoveArrayParams.argtypes = []
...
BMC_SetMultiChannelMoveArraySection.argtypes = []
...
BMC_SetPositionTriggerState.argtypes = []
...
BMC_SetRackDigitalOutputs.argtypes = []
...
BMC_SetRasterScanMoveParams.argtypes = []
...
BMC_SetTriggerIOConfigParamsBlock.argtypes = []
...
BMC_StartMultiChannelMoveArray.argtypes = []
...
BMC_StopImmediateSynchronously.argtypes = []
...
BMC_StopProfiledSynchronously.argtypes = []
...
BMC_VectorMoveToPosition.argtypes = []
...
TLI_CreateManualDeviceEntry.argtypes = []
...
TLI_DeleteManualDeviceEntry.argtypes = []
...
TLI_ScanEthernetRange.argtypes = []
