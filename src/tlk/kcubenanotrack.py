...
NT_CanDeviceLockFrontPanel.argtypes = []
...
NT_GetFeedbackLoopPIconsts.argtypes = []
...
NT_GetFeedbackLoopPIconstsBlock.argtypes = []
...
NT_GetFrontPanelLocked.argtypes = []
...
NT_GetTriggerConfigParamsBlock.argtypes = []
...
NT_IsXYScanLineAvailable.argtypes = []
...
NT_RequestFeedbackLoopPIconsts.argtypes = []
...
NT_RequestFeedbackMode.argtypes = []
...
NT_RequestFrontPanelLocked.argtypes = []
...
NT_RequestTriggerConfigParams.argtypes = []
...
NT_SetFeedbackLoopPIconsts.argtypes = []
...
NT_SetFeedbackLoopPIconstsBlock.argtypes = []
...
NT_SetTriggerConfigParamsBlock.argtypes = []
